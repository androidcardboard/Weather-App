...
class CityDaily() : Parcelable {
    ...
    companion object CREATOR : Parcelable.Creator<CityDaily> {
        override fun createFromParcel(parcel: Parcel): CityDaily {
            return CityDaily(parcel)
        }

        override fun newArray(size: Int): Array<CityDaily?> {
            return arrayOfNulls(size)
        }
    }
}