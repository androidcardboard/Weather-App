...
import com.weather.adapter.HourlyAdapter

import com.weather.util.Constant
import com.weather.viewmodel.FiveDaysViewModel
        ...
        if (requestCode == REQUEST_CODE) {
            if (grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(context,
                        "Permission Denied, You cannot access location data", Toast.LENGTH_LONG)
                    .show()
            }
        }
